package com.shang.zk.zookeeper.base;
...
//	static final String CONNECT_ADDR = "192.168.80.88:2181,192.168.80.87:2181,192.168.80.86:2181";
	static final String CONNECT_ADDR = "172.22.14.150:2181";
	/** session超时时间 */
	...
	public static void main(String[] args) throws Exception{
		...
		System.out.println("..");
		//创建父节点
//		zk.create("/testRoot1", "testRoot".getBytes(), Ids.OPEN_ACL_UNSAFE, CreateMode.EPHEMERAL);
