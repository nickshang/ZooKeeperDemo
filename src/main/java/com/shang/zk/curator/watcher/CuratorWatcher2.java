package com.shang.zk.curator.watcher;
...
public class CuratorWatcher2 {
	...
	public static void main(String[] args) throws Exception {
		...
		cache.getListenable().addListener(new PathChildrenCacheListener() {
			 ...
			 * @see org.apache.curator.framework.recipes.cache.PathChildrenCacheListener#childEvent(CuratorFramework, org.apache.curator.framework.recipes.cache.PathChildrenCacheEvent)
			 */
			@Override
